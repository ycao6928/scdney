...
RcppExport SEXP _scdney_Rtsne_cpp(SEXP ISEXP, SEXP JSEXP, SEXP VSEXP, SEXP no_dims_inSEXP, SEXP perplexity_inSEXP, SEXP theta_inSEXP, SEXP verboseSEXP, SEXP max_iterSEXP, SEXP Y_inSEXP, SEXP initSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_scdney_Rtsne_cpp", (DL_FUNC) &_scdney_Rtsne_cpp, 10},
    {"projsplx", (DL_FUNC) &projsplx, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_scdney(DllInfo *dll) {
